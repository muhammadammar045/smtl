...
export interface AttendanceDetailData {
    student: Student;
    from_date: string; // "2025-03-01"
    to_date: string;   // "2025-03-31"
...
export interface AttendanceRecord {
    ...
    device_uid: string;
    device_dep: string;
    checkindate: string;   // "2025-03-01"
    timein: string;        // "07:59:00"
    checkedin_passed: string;
    timeout: string;
    card_out: string;
    timestamp: string;     // "2025-03-01 04:25:19"
    sms_sent: string;
    sms_logout: string;
    staff_attendance_type_id: string;
    type: "Present" | "Absent" | "Late" | "Holiday" | "Half Day" | "Leave" | "Off";
    key_value: string; // contains HTML <b>...</b>
}
